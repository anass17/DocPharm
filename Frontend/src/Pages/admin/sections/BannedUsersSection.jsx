...
import BannedUserDetailsDrawer from "../../../components/Drawer/Users/BannedUserDetailsDrawer";
...
const BannedUsersSection = () => {
    ...
    const getUsers = async () => {
        ...
        try {
            ...
            const response = await fetch(`${backend_url}/api/users?status=banned&type=${type}&page=${page}&search=${search}&sort=${sort}`, {
                headers: {
    ...
    return (
        <>
            ...
            <BannedUserDetailsDrawer user={selected} open={open} setOpen={setOpen} />
        </>
