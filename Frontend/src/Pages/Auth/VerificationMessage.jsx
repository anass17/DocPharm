    ...
    <>
      <Container maxWidth="lg" sx={{ pt: 8, display:"flex", alignItems:'center', height: '100vh' }}>
            <Box py={{xs: 7, md: 10 }} px={{ xs: 3, md: 10 }} textAlign={"center"} sx={{ position: 'relative', backgroundColor: '#FFF', width: '100%', borderRadius: '5px', boxShadow: '0px 1px 2px rgba(0, 0, 0, .15)', border: '1px solid rgba(0, 0, 0, .1)' }}>
                ...
                <Typography variant="body1" mb={5}>We have sent you a verification email to <Typography display={"inline"} fontWeight={700} color="#00A2ED" component={"span"}>{user.email}</Typography>. Please check your inbox and click on the link to proceed. If you can't find the email please check your spam folder.</Typography>
