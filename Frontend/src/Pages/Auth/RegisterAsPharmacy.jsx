...
function RegisterAsPharmacy() {
    ...
    async function sendRegisterData() {
        ...
        try {
            const response = await fetch(backend_url + '/api/registeraspharmacy', {
                method: 'POST',
                headers: {
        ...
        <form onSubmit={handleNextButton} style={{ textAlign: 'center', marginTop: 75 }}>
            <Grid2 container spacing={5}>
                ...
                <Grid2 size={{md: 6, xs: 12}}>
                    ...
                    <TextField label="Pharmacy Name" name="pharmacy_name" value={data.pharmacy_name} error={!errors.pharmacy_name ? false : true} onChange={handleChange} variant="outlined" sx={{ marginBottom: 2, backgroundColor: '#F9F9F9' }} fullWidth />
        ...
        <form style={{ textAlign: 'center', marginTop: 75 }}>
            <Grid2 container spacing={5}>
                ...
                <Grid2 size={{md: 6, xs: 12}}>
                    ...
                    <TextField name="address" value={data.address} error={!errors.address ? false : true} onChange={handleChange} variant="outlined" label="Address" rows={4} multiline fullWidth sx={{ mb: 2, bgcolor: '#F9F9F9' }}></TextField>
