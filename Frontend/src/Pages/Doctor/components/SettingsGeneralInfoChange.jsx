            ...
            <Box sx={{ bgcolor: '#FFF', borderRadius: 2, p: 2.5, mb: 5, boxShadow: '0px 1px 2px rgba(0, 0, 0, .2)' }}>
                ...
                <Row gutter={[10, 16]} style={{ margin: '1.25rem 0' }}>
                    <Col xs={24} sm={12}>
                        ...
                        <Input type='text' size="large" placeholder="What's your first name?" onChange={handleGeneralInfoChange} value={generalInfoData.first_name} name="first_name" />
                        <Typography.Text style={{ color: 'red' }}>{generalInfoErrors.first_name}</Typography.Text>
                    </Col>
                    <Col xs={24} sm={12}>
                        <InputLabel>Last Name</InputLabel>
                        <Input type='text' size="large" placeholder="What's your last name?" onChange={handleGeneralInfoChange} value={generalInfoData.last_name} name="last_name" />
                ...
                <Box style={{ margin: '1.25rem 0' }}>
                    <Col span={24}>
                        ...
                        <TextArea rows={3} size="large" style={{ resize: 'none' }} placeholder="Add your bio ..." onChange={handleGeneralInfoChange} value={generalInfoData.bio} name="bio" />
                ...
                <Row gutter={[10, 16]} style={{ margin: '1.25rem 0' }}>
                    <Col xs={24} sm={18}>
                        ...
                        <Input type='text' size="large" placeholder="Add your work address ..." onChange={handleGeneralInfoChange} value={generalInfoData.address} name="address" />
                        <Typography.Text style={{ color: 'red' }}>{generalInfoErrors.address}</Typography.Text>
                    </Col>
                    <Col xs={24} sm={6}>
                        <InputLabel>City *</InputLabel>
                        <Input type='text' size="large" placeholder="Add your work city ..." onChange={handleGeneralInfoChange} value={generalInfoData.city} name="city" />
