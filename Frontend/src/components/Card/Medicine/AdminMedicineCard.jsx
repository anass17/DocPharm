...
import MedicineCardOptionsButton from '../../Button/MedicineCardOptionsButton';
import AdminDeleteMedicineModal from '../../Modal/Medicine/AdminDeleteMedicineModal';
...
const AdminMedicineCard = ({medicine, onDeleteMedicine}) => {
    ...
    return (
        <Card sx={{ position: 'relative' }}>
            ...
            <Box position={'absolute'} top={10} right={10}>
                <MedicineCardOptionsButton onUpdate={handleUpdate} onDelete={handleDelete}/>
            </Box>

            {/* <UpdateMedicineModal medicine={medicine} open={update} setOpen={setUpdate} handleUpdate={onUpdateMedicine} /> */}

            <AdminDeleteMedicineModal medicine={medicine} open={del} setOpen={setDel} handleUpdate={onDeleteMedicine} />
        </Card>
    );
}
