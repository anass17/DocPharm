...
function PreLoggedNavbar({bgColor = '#FFF', textColor = colors.GRAY0, shadow = '0px 0px 2px rgba(0, 0, 0, .2)', logo="logo.png", position="static"}) {
...
export default PreLoggedNavbar;
