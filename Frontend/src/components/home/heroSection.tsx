...
export default function HeroSection() {
    ...
    return (
        <Container sx={{ height: '100vh', display: 'flex', alignItems: 'center', backgroundImage: `linear-gradient(${LIGHT_GREEN1 + '60'}, #fff)` }}>
            <Grid2 container spacing={2}>
                ...
                <Grid2 size={6}>
                    <img src="/images/home_herosection.png" style={{maxWidth: '100%'}}></img>
                </Grid2>
            </Grid2>
        </Container>
    )
