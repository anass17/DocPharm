    ...
    return (
        <Box sx={{ backgroundColor: '#F7F7F7' }}>
            <Container maxWidth="lg" sx={{ py: "70px" }}>
                <Typography variant="h5" color={DARK_GRAY0} textAlign={'center'} component='h2' mb={3}>Services We Offer</Typography>
                <Typography variant="body1" mb={7} textAlign={'center'} color={DARK_GRAY2}>
                    Comprehensive healthcare solutions designed for your convenience
                </Typography>
                <Grid2 container spacing={4}>
                    <Grid2 size={3}>
                        <svg xmlns="http://www.w3.org/2000/svg" style={{ fill: DARK_GREEN, width: '40px' }} viewBox="0 0 448 512">
                        ...
                        <StyledHeadline>Order Medicines</StyledHeadline>
                        <Typography>consectetur adipisicing elit. Obcaecati omnis iusto aliquid dicta recusandae minus a ad </Typography>
                    </Grid2>
                    <Grid2 size={3} gap={2}>
                        <svg xmlns="http://www.w3.org/2000/svg" style={{ fill: DARK_GREEN, width: '40px' }} viewBox="0 0 576 512">
                            {/* <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--> */}
                        ...
                        <StyledHeadline>Find Doctors</StyledHeadline>
                        <Typography>consectetur adipisicing elit. Obcaecati omnis iusto aliquid dicta recusandae minus a ad </Typography>
                    </Grid2>
                    <Grid2 size={3} gap={2}>
                        <svg xmlns="http://www.w3.org/2000/svg" style={{ fill: DARK_GREEN, width: '40px' }} viewBox="0 0 576 512">
                        ...
                        <StyledHeadline>Browse Phamacies</StyledHeadline>
                        <Typography>consectetur adipisicing elit. Obcaecati omnis iusto aliquid dicta recusandae minus a ad </Typography>
                    </Grid2>
                    <Grid2 size={3} gap={2}>
                        <svg xmlns="http://www.w3.org/2000/svg" style={{ fill: DARK_GREEN, width: '40px' }} viewBox="0 0 576 512">
                        ...
                        <StyledHeadline>Check Articles</StyledHeadline>
                        <Typography>consectetur adipisicing elit. Obcaecati omnis iusto aliquid dicta recusandae minus a ad </Typography>
                    </Grid2>
                </Grid2>
            </Container>
