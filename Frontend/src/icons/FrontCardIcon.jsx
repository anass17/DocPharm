export default function FrontCardIcon({mr = 12, width = 22, height = 22, fill = "#333"}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} style={{ fill: fill, marginRight: mr }} viewBox="0 0 576 512">
