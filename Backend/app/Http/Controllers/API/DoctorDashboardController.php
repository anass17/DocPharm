...
class DoctorDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json(['statistics' => $statistics, 'recent_added' => $recent_added, 'chart' => $this -> getAppointmentsCountPerMonth()]);
    }

    private function getAppointmentsCountPerMonth() {
