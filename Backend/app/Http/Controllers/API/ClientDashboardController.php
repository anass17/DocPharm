...
class ClientDashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        $apt_statistics = Appointment::selectRaw("
            ...
            COUNT(CASE WHEN appointment_status = 'rejected' THEN 1 END) as rejected_appointments,
        ...
        return response()->json(['statistics' => [$apt_statistics, $order_statistics], 'recent_activities' => $recent_activities, 'chart' => $this -> getAppointmentsCountPerMonth($request)]);
    }
